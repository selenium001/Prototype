...
public class regression_onboarding_uniqlyYours extends baseClass {
	signInPage signInPg;
	...
	public regression_onboarding_uniqlyYours() {
		super();
	}

//verify on-boarding with newToNumi, choosing uniquely yours plan.
	@BeforeClass
	...
	public void onb_newUser_chooseNsPlanListPage() {
		...
		firstWeekStagePg = chooseNsPlanListPg.choosePlan(chooseNsPlanListPg.uniqYrs);
		System.out.println("==================================================================================");
